...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
	m9k_smg_uzi = {
		...
		OnThink = function( self, wepent, isdead )
			-- Simulate switching the firemode on the gun
			local useAnim = self:LookupSequence( "flinch_shoulder_l" )
			if LambdaRNG( 800 ) == 1 then
				...
				wepent.FireMode = isFull and "Semi" or "Full"
				wepent:EmitSound( "Weapon_AR2.Empty", 65 )
				--PrintMessage( HUD_PRINTTALK, "Switched to " .. wepent.FireMode .. " FireMode" )
